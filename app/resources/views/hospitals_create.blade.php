...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('医療機関登録画面') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hospitals.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="web_url" type="text" class="form-control @error('web_url') is-invalid @enderror" name="web_url" value="{{ old('web_url') }}" required autocomplete="web_url">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="intro" class="form-control @error('intro') is-invalid @enderror" name="intro" rows="6" required autocomplete="intro">{{ old('intro') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ken_name" type="text" class="form-control @error('ken_name') is-invalid @enderror" name="ken_name" value="{{ old('ken_name') }}" required autocomplete="ken_name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="town_name" type="text" class="form-control @error('town_name') is-invalid @enderror" name="town_name" value="{{ old('town_name') }}" required autocomplete="town_name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="block_name" type="text" class="form-control @error('block_name') is-invalid @enderror" name="block_name" value="{{ old('block_name') }}" autocomplete="block_name">
